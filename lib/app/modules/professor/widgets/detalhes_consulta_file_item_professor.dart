...
class DetalhesConsultaFileItemProfessor extends StatefulWidget {
  final ArquivoViewModel arquivo;
  final ConsultaViewModel consulta;
  const DetalhesConsultaFileItemProfessor(this.arquivo,
      this.consulta,
      {Key? key,
     })
      : super(key: key);
  ...
  @override
  _DetalhesConsultaFileItemProfessorState createState() =>
      _DetalhesConsultaFileItemProfessorState();
}

class _DetalhesConsultaFileItemProfessorState extends ModularState<
    DetalhesConsultaFileItemProfessor, DetalhesConsultaProfessorStore> {
